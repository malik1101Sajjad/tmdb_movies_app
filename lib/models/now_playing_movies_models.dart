...
class NowPlayingMovies {
  ...
  factory NowPlayingMovies.fromJson(String source) =>
      NowPlayingMovies.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'NowPlayingMovies(id:$id title: $title, overview: $overview, release_date: $release_date, media_type: $media_type, poster_path: $poster_path, backdrop_path: $backdrop_path, vote_count: $vote_count, vote_average: $vote_average, popularity: $popularity)';
  }

  @override
  bool operator ==(covariant NowPlayingMovies other) {
