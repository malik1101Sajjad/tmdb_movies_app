...
class TrandingMovies {
  ...
  factory TrandingMovies.fromMap(Map<String, dynamic> map) {
    return TrandingMovies(
      id: map['id'] as int? ?? 0,
  ...
  factory TrandingMovies.fromJson(String source) =>
      TrandingMovies.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'TrandingMovies(id:$id title: $title, overview: $overview, release_date: $release_date, media_type: $media_type, poster_path: $poster_path, backdrop_path: $backdrop_path, vote_count: $vote_count, vote_average: $vote_average, popularity: $popularity)';
  }

  @override
  bool operator ==(covariant TrandingMovies other) {
